...
/* PWM */
#define CM_PWM        __REG32(0xFE1010A0)
#define PWM_BASE      __REG32(PER_BASE + 0x20C000)
#define PWM_CTRL      __REG32(PWM_BASE + 0x0)
#define PWM_STA       __REG32(PWM_BASE + 0x04)
#define PWM_DAT_0     __REG32(PWM_BASE + 0x0C)
#define PWM_RANGE_0   __REG32(PWM_BASE + 0x14)
#define PWM_CLK       __REG32(PWM_BASE + 0x28)
